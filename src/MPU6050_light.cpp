...
void MPU6050::update(){
  ...
  angleAccY = - atan2(accX, sgZ*sqrt(accZ*accZ + accY*accY)) * RAD_2_DEG; // [- 90,+ 90] deg //also 180 degrees now
  ...
  angleY = wrap(filterGyroCoef*(angleAccY + wrap(angleY +     gyroY*dt - angleAccY,180)) + (1.0-filterGyroCoef)*angleAccY, 180);
